            ...
            <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-14 py-[86px]">
              ...
              <div className="flex flex-col lg:flex-row justify-center items-start w-full lg:w-[90%] mx-auto mb-[52px]">
                <div className="flex justify-center items-center w-full lg:w-[980px] mx-auto mb-16 lg:mb-0">
                  <div className="w-20 h-20 bg-[#f7f7f7] rounded-[40px] flex justify-center items-center mt-[68px] order-1">
                  ...
                  <div className="flex flex-col gap-6 justify-start items-center self-center flex-1 px-8 lg:px-14 order-2">
                    <div className="flex flex-col lg:flex-row justify-between items-center w-full mx-auto mr-0 lg:mr-[30px]">
                      <span className="text-sm font-medium leading-[22px] text-left text-[#344054] font-[Helvetica Neue] mb-4 lg:mb-0">
                        Our Customers
                      </span>
                      <span className="text-sm font-medium leading-[22px] text-left text-[#344054] font-[Helvetica Neue] mb-4 lg:mb-0">
                        Talk About IT
                      </span>
                      <span className="text-sm font-medium leading-[22px] text-left text-[#344054] font-[Helvetica Neue]">
                        Better Than Us
                      </span>
                    </div>

                    <div className="flex flex-col gap-8 justify-start items-center w-full mr-0 lg:mr-2.5">
                      <h2 className="text-2xl md:text-3xl lg:text-7xl font-medium leading-9 sm:text-[54px] lg:leading-[72px] text-center capitalize text-[#08080c] font-[Helvetica Neue] w-full">
                        Hear What Customer Have to Say
                      </h2>
                      <p className="text-lg lg:text-sm font-medium leading-[22px] sm:leading-[27px] text-center capitalize text-[#6b7280] font-[Helvetica Neue] w-full lg:w-[68%]">
                  ...
                  <div className="w-20 h-20 bg-[#f7f7f7] rounded-[40px] flex justify-center items-center mt-[46px] order-3">
